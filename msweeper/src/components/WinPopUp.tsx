...
const WinPopUp: React.FC<WinPopUpProps> = ({showPopUp, gameWonAftermath}) => {
  ...
  return (
    ...
    showPopUp ? (
        ...
        m-auto ssm:w-[80vw] sm:w-[20vw] h-[17.5vh] left-0 right-0 top-0 bottom-0 transition-all animate-fade-in-down">
        ...
        placeholder={"your name..."}
            className="transition-all rounded shadow-2xl w-[90%] h-[5vh] sm:px-[0.5vw] ssm:px-[2vw] bg-slate-400 text-white hover:bg-slate-200 hover:text-black hover:placeholder-black placeholder-white "
            type="text"
            autoFocus
        />
        </div>
